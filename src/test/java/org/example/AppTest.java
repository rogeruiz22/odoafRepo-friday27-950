...
//         WebElement selectAllContactsCheckbox = driver.findElement(By.xpath("(//span[@class='slds-checkbox--faux'])[1]"));
        WebElement someoneSpecific = driver.findElement(By.xpath("(//a[text()='Marcie Jimenez']/ancestor::tr//td/following-sibling::td[@class='slds-cell-edit cellContainer'])[1]"));
        someoneSpecific.click();
